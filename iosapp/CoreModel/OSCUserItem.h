...
@class OSCUserStatistics, OSCUserMoreInfo, OSCUserEventInfo, OSCUserIdentity;
...
@property (nonatomic, strong) OSCUserEventInfo *eventInfo;
...
/* 活动出席人员节点 */
@interface OSCUserEventInfo : NSObject
...
@interface OSCUserIdentity : NSObject

@property (nonatomic, assign) BOOL officialMember;
@property (nonatomic, assign) BOOL softwareAuthor;
