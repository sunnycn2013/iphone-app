...
- (void)setCommentDetail:(OSCCommentItem *)commentDetail
{
    [_portraitView loadPortrait:[NSURL URLWithString:commentDetail.author.portrait] userName:commentDetail.author.name];
    _nameLabel.text = commentDetail.author.name;
    _timeLabel.text = [[NSDate dateFromString:commentDetail.pubDate] timeAgoSince];//[NSString stringWithFormat:@"%@(%@)", [[NSDate dateFromString:commentDetail.pubDate] timeAgoSinceNow], commentDetail.pubDate];
