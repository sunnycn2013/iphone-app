...
-(void)setViewModel:(OSCQuestion *)viewModel{
    ...
    [_iconImageView loadPortrait:[NSURL URLWithString:viewModel.authorPortrait] userName:viewModel.author];
...
- (void)setListItem:(OSCListItem *)listItem{
    ...
    [_iconImageView loadPortrait:[NSURL URLWithString:listItem.author.portrait] userName:listItem.author.name];
