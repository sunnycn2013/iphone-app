               ...
               currentMenuItem:(OSCMenuItem* )curMenuItem
{
    ...
    NSDictionary* response = [NSObject responseObjectWithResource:cacheResource cacheType:SandboxCacheType_list];
    ...
    if (curMenuItem.banner.href) {
        ...
        NSDictionary* bannerResponse = [NSObject responseObjectWithResource:bannerCacheResource cacheType:SandboxCacheType_banner];
