...
{
    [_portraitIv loadPortrait:[NSURL URLWithString:blogDetail.authorPortrait] userName:blogDetail.author];
    _nameLabel.text = blogDetail.author;
    
    _pubTimeLabel.text = [NSString stringWithFormat:@"发表于%@", [[NSDate dateFromString:blogDetail.pubDate] timeAgoSince]];
