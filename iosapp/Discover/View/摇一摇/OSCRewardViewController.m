...
#define PRIVATE_KEY @"w2%9M4&4" //「密钥」字符串
...
/** larger gift pop view */
    ...
    [mutableDic setObject:token forKey:@"appToken"];

    NSSortDescriptor* sortDesc = [NSSortDescriptor sortDescriptorWithKey:nil ascending:YES];
    NSArray* paraArr = @[timeString,token,[NSString stringWithFormat:@"%ld",(long)userID],PRIVATE_KEY];
