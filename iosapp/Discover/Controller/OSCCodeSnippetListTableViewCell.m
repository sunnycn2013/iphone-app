//
//  OSCCodeSnippetListTableViewCell.m
//  iosapp
//
...
@interface OSCCodeSnippetListTableViewCell ()
...
@implementation OSCCodeSnippetListTableViewCell
...
- (void)setModel:(OSCCodeSnippetListModel *)model {
    _model = model;
    [self layoutUI:model];
    //赋值
    ...
    _descriptionLabel.text = model.code_description;
    [_infoLabel setAttributedText:model.infoAttribute];
    _langueLabel.text = model.language;
    
}

- (void)layoutUI:(OSCCodeSnippetListModel *)model{
