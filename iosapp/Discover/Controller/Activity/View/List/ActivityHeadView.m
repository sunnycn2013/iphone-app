...
- (void)setUpUI:(CGRect)frame
{
    ...
    _subImageView.contentMode = UIViewContentModeScaleToFill;//图片拉伸变形
...
{
    [_subImageView loadPortrait:[NSURL URLWithString:banner.img] userName:nil];

    [_bottomImage loadPortrait:[NSURL URLWithString:banner.img] userName:nil];
