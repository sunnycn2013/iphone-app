...
- (void)initSubviews
{
    ...
    _posterView.contentMode = UIViewContentModeScaleToFill;//图片拉伸变形//.contentMode = UIViewContentModeScaleAspectFill;
...
- (void)setLayout
{
    ...
    NSDictionary *views = NSDictionaryOfVariableBindings(_posterView, _titleLabel, _descriptionLabel, _tabImageView, _signInButton);
