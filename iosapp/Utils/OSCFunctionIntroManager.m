...
#import "NSObject+Comment.h"//v3.7.7清理旧数据
#import "Utils.h"
...
+ (OSCIntroView* )showIntroPage{
    if ([self isNeedShowIntroPage]) {
        ...
        [NSObject clearOldCache];//v3.7.7清理旧数据
        [Utils getNomalAttentionContacterAndSaveToAttentionContacter];
        
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"noticeMention"];//v3.7.7清理旧数据
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"noticeLetter"];//v3.7.7清理旧数据
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"noticeReview"];//v3.7.7清理旧数据
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"noticeFans"];//v3.7.7清理旧数据
        [[NSUserDefaults standardUserDefaults] removeObjectForKey:@"noticeLike"];//v3.7.7清理旧数据
