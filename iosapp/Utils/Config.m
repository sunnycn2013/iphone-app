...
+ (void)saveLastUploadTime:(NSString *)timeStr {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setObject:timeStr ?: @"" forKey:kUploadTime];
    [userDefaults synchronize];
}

+ (NSString *)getLastUploadTime {
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    return [userDefaults objectForKey:kUploadTime] ?:@"";
}
...
+ (void)saveMsgCount:(OSCMsgCount* )msgCount
{
    ...
    if ([userDefaults integerForKey:userDefault_mention_key] != msgCount.mention) {
        [userDefaults setInteger:msgCount.mention forKey:userDefault_mention_key];
        [userDefaults setObject:[NSDate date] forKey:userDefault_mention_key_updateTime];
    }
    
    if ([userDefaults integerForKey:userDefault_letter_key] != msgCount.letter) {
        [userDefaults setInteger:msgCount.letter forKey:userDefault_letter_key];
        [userDefaults setObject:[NSDate date] forKey:userDefault_letter_key_updateTime];
    }
    
    if ([userDefaults integerForKey:userDefault_review_key] != msgCount.review) {
        [userDefaults setInteger:msgCount.review forKey:userDefault_review_key];
        [userDefaults setObject:[NSDate date] forKey:userDefault_review_key_updateTime];
    }
    
    [userDefaults setInteger:msgCount.fans forKey:userDefault_fans_key];
    [userDefaults setInteger:msgCount.like forKey:userDefault_like_key];
    
    [[UIApplication sharedApplication] setApplicationIconBadgeNumber:msgCount.totalCount];
...
+ (OSCMsgCount* )getCurMsgCount
{
    ...
    OSCMsgCount* curMsgCount = [OSCMsgCount new];
    curMsgCount.mention = [userDefaults integerForKey:userDefault_mention_key];
    curMsgCount.letter = [userDefaults integerForKey:userDefault_letter_key];
    curMsgCount.review = [userDefaults integerForKey:userDefault_review_key];
    curMsgCount.fans = [userDefaults integerForKey:userDefault_fans_key];
    curMsgCount.like = [userDefaults integerForKey:userDefault_like_key];
    return curMsgCount;
}
