...
#define forwardView_FullWidth_list          (kScreen_W) - (padding_left) - (userPortrait_W)
#define forwardView_FullWidth_detail        (kScreen_W) - (padding_left) - (padding_right)
#define forwardView_FullWidth_editorUI      (kScreen_W) - (padding_left) - (padding_right)
...
#define descTextView_space_imageView 8
#define descTextView_space_forwardView 4
#define descTextView_space_timeAndSourceLabel 4
#define imageView_space_timeAndSourceLabel 8
#define forwardView_space_timeAndSourceLabel 8
#define timeAndSourceLabel_W 190
#define timeAndSourceLabel_H 16
#define commentCountLabel_W 25
#define commentCountLabel_H 16
#define operationBtn_space_label 1
#define like_space_comment 6
...
@class AsyncDisplayTableViewCell,OSCPhotoGroupView,OSCForwardView,YYLabel;
