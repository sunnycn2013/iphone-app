...
@interface ImageViewerController () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
                      ...
                      placeholderImage:nil
                             ...
                             completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                                 if (image) {
                                     ...
                                     dispatch_async(dispatch_get_main_queue(), ^{
                                         _HUD.label.text = @"图片无法加载,请重新上传头像";
...
- (void)downloadPicture
{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"下载图片至手机相册"
                                                                             message:@""
