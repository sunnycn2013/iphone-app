...
@interface OSCGitCommentViewController ()<UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate,OSCPopInputViewDelegate,CommentTextViewDelegate, OSCCommetCellDelegate>
...
@implementation OSCGitCommentViewController
