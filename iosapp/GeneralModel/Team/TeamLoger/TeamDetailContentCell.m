...
{
    [_portrait loadPortrait:detail.author.portraitURL userName:detail.author.name];
    _authorLabel.text = detail.author.name;
    _timeLabel.text = [detail.createTime timeAgoSince];
    self.contentLabel.attributedText = detail.summary;
}

- (void)setContentWithActivity:(TeamActivity *)activity
{
    [_portrait loadPortrait:activity.author.portraitURL userName:activity.author.name];
    _authorLabel.text = activity.author.name;
    _timeLabel.text = [activity.createTime timeAgoSince];
