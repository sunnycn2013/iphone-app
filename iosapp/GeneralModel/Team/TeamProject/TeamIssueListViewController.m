...
- (instancetype)initWithTeamID:(int)teamID projectID:(int)projectID andSource:(NSString *)source
{
    if (self = [super init]) {
        ...
        self.generateURL = ^NSString * (NSUInteger page) {
            return [NSString stringWithFormat:@"%@%@?uid=%ld&teamid=%d&projectid=%d&source=%@", OSCAPI_PREFIX, TEAM_PROJECT_CATALOG_LIST,
                    (long)[Config getOwnID], teamID, projectID, source];
        };
