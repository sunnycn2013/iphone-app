...
@interface FeedBackViewController () <UINavigationControllerDelegate, UIImagePickerControllerDelegate,UITextViewDelegate>
...
- (void)textViewDidChange:(UITextView *)textView{
    if ([textView isEqual:_feedbackTextView]) {
