...
- (IBAction)highlightedState:(UIButton *)sender {
    _registerButton.backgroundColor = ButtonPressedBackgroundColor;
}

- (IBAction)outSideState:(UIButton *)sender {
    _registerButton.backgroundColor = ButtonNormalBackgroundColor;
}
...
- (void)buttonStateEnable
{
    if (_phoneNumberTextField.text.length == MAX_PHONENUMBER_LENGTH && _captchaTextField.text.length > 0) {
        ...
        _registerButton.backgroundColor = ButtonLoginDissableBackgroundColor;
        [_registerButton setTitleColor:ButtonLoginDissableTextColor forState:UIControlStateNormal];
