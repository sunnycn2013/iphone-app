...
- (void)viewDidLoad {
    ...
    _captchaButton.layer.borderColor = ButtonCaptchaNormalBorderColor;
    _captchaButton.enabled = NO;
    _captchaButton.alpha = 0.4;
    ...
    dispatch_source_set_event_handler(_timer, ^{
        ...
        if(time <= 0){ //倒计时结束，关闭
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [_captchaButton setTitleColor:ButtonCaptchaNormalTextColor forState:UIControlStateNormal];
                _captchaButton.layer.borderColor = ButtonCaptchaNormalBorderColor;
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [_captchaButton setTitleColor:ButtonCaptchaUnEnabledTextColor forState:UIControlStateNormal];
                _captchaButton.layer.borderColor = ButtonCaptchaUnEnabledBorderColor;
...
- (IBAction)highlightedState:(UIButton *)sender {
    _nextButton.backgroundColor = ButtonPressedBackgroundColor;
}

- (IBAction)outSideState:(UIButton *)sender {
    _nextButton.backgroundColor = ButtonNormalBackgroundColor;
}
...
- (void)buttonStateEnable
{
    if (_phoneNumberTextField.text.length == MAX_PHONENUMBER_LENGTH && _captchaTextField.text.length > 0) {
        _nextButton.backgroundColor = ButtonNormalBackgroundColor;
        [_nextButton setTitleColor:ButtonNormalTextColor forState:UIControlStateNormal];
        _nextButton.enabled = YES;
    } else {
        _nextButton.backgroundColor = ButtonLoginDissableBackgroundColor;
        [_nextButton setTitleColor:ButtonLoginDissableTextColor forState:UIControlStateNormal];
