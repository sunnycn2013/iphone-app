...
- (void)buttonStateEnable
{
    if (_textField.text.length > 5) {
        _resetButton.backgroundColor = ButtonNormalBackgroundColor;
        [_resetButton setTitleColor:ButtonNormalTextColor forState:UIControlStateNormal];
        _resetButton.enabled = YES;
    } else {
        _resetButton.backgroundColor = ButtonLoginDissableBackgroundColor;
        [_resetButton setTitleColor:ButtonLoginDissableTextColor forState:UIControlStateNormal];
