...
- (void)setCommentItem:(CommentItem *)commentItem{
    ...
    [_userPortraitImageView loadPortrait:[NSURL URLWithString:commentItem.author.portrait] userName:commentItem.author.name];
    ...
    NSMutableAttributedString *att = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@", [[NSDate dateFromString:commentItem.pubDate] timeAgoSince]]];
